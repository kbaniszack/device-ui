...
void create_screen_boot_screen() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff08d0b5), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_label_set_text(obj, "https://skipple.fr");
        }
        {
            // FirmwareLabel
            lv_obj_t *obj = lv_label_create(parent_obj);
